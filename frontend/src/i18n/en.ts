...
export const en_texts = {
  ...
  UPLOAD_FILES_FORM_DESCRIPTION:
    'Upload files to convert to text. Use the regex form to improve the data extraction.',
  NAME: 'Name',
  REGEX: 'Regex',
  ...
  EXTRACTION_CONFIG_TAB_DESCRIPTION:
    'This is your extraction configuration for this file set, you can refine it and process the extraction again.',
  RAW_TEXT: 'Raw text',
  ...
  SETTINGS: 'Settings',
  PROCESSED_FILES_TITLE: 'Processed Files',
  TOTAL_PROCESSED_FILES: 'Total Processed Files',
  ...
  RESET_PWD_DESCRIPTION: 'To reset your password, send an email to support@extractify.com',
  PWD_UPDATE: 'Update password',
  PWD_UPDATE_DESCRIPTION: 'Update your password',
  PWD_UPDATE_PLACEHOLDER: 'Enter your new password',
